...
namespace DohunKim.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AuthorName,ProjectName")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AuthorName,ProjectName")] Author author)
        {
